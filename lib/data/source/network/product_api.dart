...
abstract class ProductApi {
  ...
  Future<ProductDto> updateProduct(ProductDto productDto);
  Future<ProductDto> delteProduct(String productID);
}
...
class ProductApiImpl implements ProductApi {
  ...
  @override
  Future<ProductDto> delteProduct(String productID) async {
    try {
      // Call API
    } on DioException catch (e) {
      // The request was made and the server responded with a status code
